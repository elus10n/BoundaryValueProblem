...
namespace MATH
{
    ...
    namespace FUNC
    {
        double function_k_main(double x) { return (x < CONST::ksi) ? 1.0 : std::exp(x * x); }
        ...
        double function_k_test(double x) { return (x < CONST::ksi) ? k1_test : k2_test; }
        double function_q_test(double x) { return (x < CONST::ksi) ? q1_test : q2_test; }
        double function_f_test(double x) { return (x < CONST::ksi) ? f1_test : f2_test; }
    }
}
